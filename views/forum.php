...
<main class="threads_wrapper admin_main">
    ...
    <?php if (isset($_SESSION['privilige']) && (($_SESSION['privilige'] == '1') || ($_SESSION['privilige'] == '3'))) { ?>
    ...
    if (isset($display_message)) { ?>
        ...
        /* Check if user is logged in and has the right priviliges to see the form*/
        if (isset($_SESSION['privilige']) && ($_SESSION['privilige'] == '1' || $_SESSION['privilige'] == '3')) {  ?>
            <!-- the data-validate attribute is a condition in validator.js that is called on submit for frontend validation -->
            <form onsubmit="return validate()" method="POST" action="/forum">
                ...
                <div class="thread_question">
                    <label for="thread_question">
                        <textarea placeholder="Add your question to create a thread..." id="thread_question" name="thread_question" data-validate="str" data-min="20" data-max="10000" onkeyup="clear_parent_error(this)"></textarea>
                    </label>
