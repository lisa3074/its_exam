        ...
        <section class="events_wrapper">
            <nav class="nav_wrapper">
                <nav>
                    ...
                    <button class="iconBtn" title="Filter" onclick="setFilter()">✓</button>
                    <button class="iconBtn" title="Reset filter" onclick="resetFilter()">𝗫</button>
                </nav>
            ...
            <section class="events_wrapper">
                ...
                <?php foreach ($events as $event) {
                    ...
                    <!-- all data is wrapped in out() before being displayed, to make sure all html special characters are escaped -->
                    <article class="event">
                        <div class="event_info">
                            ...
                            <div class="event_facts">
                                ...
                                <p><a href="https://<?= out($event['event_ticket_link']) ?>" target="_blank">Buy tickets</a></p>
                            </div>
                        </div>

                        <!-- Delete button for owner and admins -->
                        <?= $hasPrivilege ? "<form class='delete_event' method='POST' action='/events/delete/{$event['event_id']}/{$event['uuid']}'><button>Delete</button></form>" : '' ?>
                        <img src="/uploads/<?= out($event['event_image']) ?>" class="bgImg" title="<?= out($event['event_image_credits']) ?>" />
                    </article>
                <?php } ?>
            </section>
        </section>
